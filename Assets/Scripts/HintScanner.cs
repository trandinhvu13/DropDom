...
public class HintScanner : MonoBehaviour
{
    ...
    {
        GameEvents.Instance.OnToggleHintScanner += ToggleHitScanner;
    }
    ...
    private void Update()
    {
        if (Input.GetKeyDown(KeyCode.H))
        {
            ...
            ToggleHitScanner(true);
        }
    }

    public void ToggleHitScanner(bool isTurnOn)
    {
        if (isTurnOn)
        {
            CheckHint = CheckForHint();
    ...
    IEnumerator CheckForHint()
    {
       ...
       // Debug.Log("____________________________________");
        ...
        for (int i = 0; i < moveableBlocks.Count; i++)
        {
            ...
            {
                Debug.Log("a");
                hintText.text = "Move block " + hint.pos.x + " " + hint.pos.y + " to " + hint.dir + " " + hint.step +
                                " step";
